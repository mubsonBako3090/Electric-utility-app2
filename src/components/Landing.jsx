          ...
          <div className="row align-items-center min-vh-100">
            <div className="col-lg-6" data-aos="fade-right">
              ...
              <div className={styles.heroButtons}>
                <button className="btn btn-primary btn-lg me-3">Report Outage</button>
                <button className="btn btn-outline-primary btn-lg">Pay Bill Online</button>
              </div>
            </div>
      ...
      <section className="section-padding bg-light">
        <div className="container">
          <div className="text-center mb-5" data-aos="fade-up">
            ...
            <p className="section-subtitle">Comprehensive energy solutions for every need</p>
          </div>
          <div className="row">
      ...
      <section className="section-padding">
        <div className="container">
          <div className="text-center mb-5" data-aos="fade-up">
            ...
            <p className={`section-subtitle ${styles.ourWorkSubtitle}`}>Modern infrastructure for reliable power</p>
          </div>
          <div className="row">
            {[1, 2, 3, 4].map((item) => (
